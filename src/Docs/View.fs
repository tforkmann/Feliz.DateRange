        ...
        Html.aside [
            ...
            prop.children [
                Html.divClassed
                    ...
                    [ Html.span [
                          color.textPrimary
                          prop.text "Feliz.DateRange"
                      ]
                      Html.a [
                          prop.href "https://www.nuget.org/packages/Feliz.DateRange"
                          prop.children [
                              Html.img [
                                  prop.src "https://img.shields.io/nuget/v/Feliz.DateRange.svg?style=flat-square"
                              ]
                          ]
                      ] ]
                Daisy.menu [
